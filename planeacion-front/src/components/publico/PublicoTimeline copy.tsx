...
/** ✅ TOTAL sesiones por espacio (para mostrar el desglose, NO “desarrolladas”) */
...
/** ✅ Sesiones desarrolladas = sesiones didácticas capturadas (bloques) */
function sesionesDesarrolladas(ut: UT): number {
      ...
      {unidadesSorted.length === 0 ? (
        ...
        <div className="space-y-3">
          {unidadesSorted.map((ut, idx) => {
            ...
            const isActive = activeIndex === idx; // ✅ SOLO vigente
              ...
              <div key={id} className="relative group">
                ...
                <div
                  ...
                  style={{
                    ...
                    borderColor: isActive ? IPN_GUINDA : IPN_GUINDA_BORDER,
                    boxShadow: isActive ? `0 0 0 6px ${IPN_GUINDA_SOFT}` : "none",
                  }}
                  aria-hidden="true"
                >
                  <div
                ...
                <div className="pl-10">
                  <div
                    ...
                    style={{
                      borderColor: isActive ? IPN_GUINDA_BORDER : SOFT_BORDER,
                      background:
              ...
              <DialogHeader>
                ...
                <div className="mt-2 flex items-center justify-end gap-2">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      setSelected((s) =>
                        Math.min(unidadesSorted.length - 1, s + 1)
                      )
                    }
                    disabled={!canNext}
                  >
