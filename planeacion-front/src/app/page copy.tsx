...
function Chip({
  ...
  return (
    <span className="inline-flex items-center gap-2 rounded-full border bg-background px-3 py-1 text-xs">
      ...
      >
        <Icon className="h-3.5 w-3.5" style={{ color: IPN_GUINDA }} />
      </span>
...
export default function Home() {
  return (
    <main className="min-h-screen bg-background text-foreground">
          ...
          <div>
            ...
            <div className="mt-4 flex flex-wrap items-center gap-2 text-xs text-muted-foreground">
              ...
              <a
                ...
                rel="noreferrer"
              >
                Publicaciones Secretaría Académica
              </a>
            </div>
          </div>
      ...
      {/* ================= FUNDAMENTO ================= */}
      <section id="fundamento" className="border-b">
      ...
      {/* ================= ESTRUCTURA (más “carnita”) ================= */}
      <section id="estructura" className="border-b bg-muted/20">
        <div className="mx-auto max-w-7xl px-4 py-14 space-y-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            <Card className="p-6">
              <div className="flex items-center gap-2">
                <Route className="h-4 w-4" style={{ color: IPN_GUINDA }} />
                <div className="font-semibold">Secuencia temporal</div>
              </div>
              <p className="mt-2 text-sm text-muted-foreground">
                Determina qué se aprende y cuándo se aprende: orden y progresión
                del aprendizaje a lo largo del periodo.
              </p>
            </Card>

            <Card className="p-6">
              <div className="flex items-center gap-2">
                <GraduationCap className="h-4 w-4" style={{ color: IPN_GUINDA }} />
                <div className="font-semibold">Experiencias de aprendizaje</div>
              </div>
              <p className="mt-2 text-sm text-muted-foreground">
                Concreta cursos o experiencias de aprendizaje asociadas a la
                unidad de aprendizaje del nivel superior.
              </p>
            </Card>

            <Card className="p-6">
              <div className="flex items-center gap-2">
                <Wrench className="h-4 w-4" style={{ color: IPN_GUINDA }} />
                <div className="font-semibold">Condiciones de operación</div>
              </div>
              <p className="mt-2 text-sm text-muted-foreground">
                Integra lo necesario para operar y desarrollar la propuesta:
                organización, recursos y condiciones para su implementación.
              </p>
            </Card>
            ...
            <Card className="p-6">
              <div className="flex items-center gap-2">
                <CheckCircle2 className="h-4 w-4" style={{ color: IPN_GUINDA }} />
                <div className="font-semibold">Evaluación del aprendizaje</div>
              </div>
              <p className="mt-2 text-sm text-muted-foreground">
                Define criterios e instrumentos para valorar los aprendizajes y
                atender requerimientos de evaluación de estudiantes y profesores.
              </p>
            </Card>

            <Card className="p-6">
              <div className="flex items-center gap-2">
                <CalendarClock className="h-4 w-4" style={{ color: IPN_GUINDA }} />
                <div className="font-semibold">Calendarización</div>
              </div>
              <p className="mt-2 text-sm text-muted-foreground">
                Considera la elaboración de un calendario de actividades para la
            ...
            <Card className="p-6">
              <div className="flex items-center gap-2">
                <Users className="h-4 w-4" style={{ color: IPN_GUINDA }} />
                <div className="font-semibold">Formación del personal</div>
              </div>
              <p className="mt-2 text-sm text-muted-foreground">
                Contempla la formación del personal académico como parte de los
                elementos indispensables para implementar una propuesta.
              </p>
            </Card>
          </div>
        </div>
      ...
      {/* ================= CÓMO SE CONCRETA ================= */}
      <section id="como-se-concreta" className="border-b">
        <div className="mx-auto max-w-7xl px-4 py-14 space-y-8">
          <div className="flex items-start gap-3">
            <div
              className="mt-0.5 flex h-10 w-10 items-center justify-center rounded-xl"
      ...
      <section id="faq" className="border-b">
        <div className="mx-auto max-w-7xl px-4 py-14 space-y-8">
          ...
          <Card className="p-6">
            <Accordion type="single" collapsible className="w-full">
              ...
              <AccordionItem value="item-3">
                ...
                <AccordionContent className="text-sm text-muted-foreground">
                  Únicamente planeaciones didácticas finalizadas por los profesores que participan en la plataforma, disponibles para consulta
          ...
          <div className="text-xs text-muted-foreground">
            Referencia institucional: Publicaciones de la Secretaría Académica
            (IPN).
          </div>
        </div>
      </section>
